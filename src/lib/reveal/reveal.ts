import { getRevealClassNames, createStylesheet } from '$lib/reveal/styling';
import { config, defOpts } from '$lib/reveal/config';
import { isStyleTagCreated, hasPageReloaded } from '$lib/reveal/stores';
import type { RevealOptions, IReturnAction } from '$lib/reveal/types';
import { getRevealNode, activateRevealNode, createObserver, logInfo } from '$lib/reveal/dom';
import { areOptionsValid } from '$lib/reveal/validation';
import { createFinalOptions } from '$lib/reveal/utils';
