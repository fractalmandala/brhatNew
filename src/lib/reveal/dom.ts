...
import { createTransitionPropertiesCSS, createTransitionDeclarationCSS, mergeRevealStyles } from '$lib/reveal/styling';
import type { RevealOptions } from '$lib/reveal/types';
import { clean, createObserverConfig } from '$lib/reveal/utils';
