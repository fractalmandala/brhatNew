...
<div class="bol-page" transition:fly>
	{#if joinIAST && joinIAST.length > 0}
	<h5 class="dev">{@html joinDev}</h5>
	<h6 class="thin">{@html joinIAST}</h6>
	{:else}
