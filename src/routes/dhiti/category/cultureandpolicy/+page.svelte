<script lang="ts">
	...
	import { allCandP } from '$lib/utils/localpulls';
	import { metaTitle, metaDescription, metaUrl, metaImage, metaType } from '$lib/stores/metastores';

	let posts: any;

	$metaUrl = 'https://www.brhat.in/dhiti/category/cultureandpolicy';
	$metaTitle = 'Culture and Policy | Dhīti at Bṛhat';
	$metaDescription = 'Essays on culture and culture-compatible policy at our blog, Dhīti.';
	$metaImage =
		'https://rnfvzaelmwbbvfbsppir.supabase.co/storage/v1/object/public/brhatwebsite/07herocovers/dhiti.webp';
	$metaType = 'webpage';

	onMount(async () => {
		posts = await allCandP(200);
	});
</script>
...
>
	<section class="rta-column rowgap400 ytop topper">
		<h3 class="bord-bot p-bot-16 p-top-16">Culture and Policy</h3>
