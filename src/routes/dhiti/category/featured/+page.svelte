<script lang="ts">
	...
	import { allFeaturedPosts } from '$lib/utils/localpulls';
	import { metaTitle, metaDescription, metaUrl, metaImage, metaType } from '$lib/stores/metastores';

	let posts: any;

	$metaUrl = 'https://www.brhat.in/dhiti/category/featured';
	$metaTitle = 'Featured Essays | Dhīti at Bṛhat';
	$metaDescription = 'The best long-reads on culture, policy and leadership at our blog, Dhīti.';
	$metaImage =
		'https://rnfvzaelmwbbvfbsppir.supabase.co/storage/v1/object/public/brhatwebsite/07herocovers/dhiti.webp';
	$metaType = 'webpage';

	onMount(async () => {
		posts = await allFeaturedPosts();
	});
</script>
...
>
	<section class="rta-column rowgap400 ytop topper">
		<h3 class="bord-bot p-bot-16 p-top-16">Featured Essays</h3>
