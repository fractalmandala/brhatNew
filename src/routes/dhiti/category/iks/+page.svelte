<script lang="ts">
	...
	import { allIKS } from '$lib/utils/localpulls';
	import { metaTitle, metaDescription, metaUrl, metaImage, metaType } from '$lib/stores/metastores';

	let posts: any;

	$metaUrl = 'https://www.brhat.in/dhiti/category/iks';
	$metaTitle = 'Indian Knowledge Systems | Dhīti at Bṛhat';
	$metaDescription = 'Essays on Indian Knowledge Systems at our blog, Dhīti.';
	$metaImage =
		'https://rnfvzaelmwbbvfbsppir.supabase.co/storage/v1/object/public/brhatwebsite/07herocovers/dhiti.webp';
	$metaType = 'webpage';

	onMount(async () => {
		posts = await allIKS(200);
	});
</script>
...
>
	<section class="rta-column rowgap400 ytop topper">
		<h3 class="bord-bot p-bot-16 p-top-16">Indian Knowledge Systems</h3>
