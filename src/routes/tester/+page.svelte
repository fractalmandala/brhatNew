...
<div class="stout rta-column p-top-128 minH" class:light={$themeMode} class:dark={!$themeMode}>
	<div class="instout rta-column rowgap400 pagila">
		<div class="rta-column rowgap400 xcenter ta-c p-bot-64">
			<h1>
				Bṛhat is a<br />
				<span style="color: #fe4a49"> Culture Engine</span>
			</h1>
			<h5 class="typett">
			...
			<div class="rta-grid grid3 rowgap400 p-bot-8">
				{#if threeactions && threeactions.length > 0}
					{#each threeactions as item, i}
						<div class="rta-column glass-bottom ta-c xcenter p-bot-16">
							<h6>{item.name}</h6>
						</div>
					{/each}
				{/if}
			...
			<a href="/about">
				<button class="newbutton red">Know More</button>
			</a>
		</div>
	</div>
